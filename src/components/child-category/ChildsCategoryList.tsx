...
const ChildsCategoryList = () => {
  return (
    <div className="rounded border p-8">
      <h2 className="text-xl font-medium">Child Category List</h2>
        ...
        <Table>
          <TableHeader className="bg-[#2B748A]">
            <TableRow className="text-white!">
              ...
              <TableHead className="text-white">Child-Category Name</TableHead>
              <TableHead className="text-white">Child-Category Image</TableHead>
...
export default ChildsCategoryList;
